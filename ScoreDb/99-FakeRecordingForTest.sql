...
UPDATE [dbo].[Recording] SET [FileName] =  @FileName1,[FilePath] = @FilePath1  WHERE RecordingId % 2 = 0
...
UPDATE [dbo].[Recording] SET [FileName] =  @FileName2,[FilePath] = @FilePath2  WHERE RecordingId % 2 = 1
UPDATE [dbo].[Event] SET [StartDateTime] = dateadd(day, rand(checksum(newid()))*(1+datediff(day, @FromDate2, @ToDate2)), @FromDate1) WHERE RecordingId % 2 = 1
