function [ scoreData ] = CheckScoreEegFileExists(scoreData)
%CheckScoreEegFileExists parses file paths and checks that
%  files exist in a 'scoreData' structure
%Input: a 'scoreData' structure from ReadScoreExtractDb
%Output: additional fields in the 'scoreData' structure
% - FileIndex: the Nicolet file number
% - FilePath2: the local file path (varies according to 
%               hospital archiving policy - code must be modified)
%
% - FilePathAndName: full file path and file name
