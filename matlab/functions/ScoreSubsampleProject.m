...
if strcmp(testData,'No Data') == 0
        ...
        ScoreQueryRun(dupQuerySearchResults);
        ...
        dupQueryAnnotationConfig = [...
        'INSERT INTO SearchResult_AnnotationConfig ([SearchResultId],[AnnotationLevel],[FieldName],[FieldComment],[HasInteger],[HasFloat],[HasString]) ' ...
        'SELECT ' num2str(newSearchId) ',[AnnotationLevel],[FieldName],[FieldComment],[HasInteger],[HasFloat],[HasString] '...
        'FROM SearchResult_AnnotationConfig ' ...
        'WHERE SearchResultId = ' num2str(searchResultId) ...
        ];
        ScoreQueryRun(dupQueryAnnotationConfig);
        ...
        ScoreQueryRun(dupQueryDescription);
        ...
        ScoreQueryRun(dupQueryEventCoding);
        ...
        '        SELECT TOP ' num2str(number) ' SearchResultStudyId FROM SearchResult_Study    ' ...
        '        WHERE SearchResultId= ' num2str(newSearchId) ...
        '        ORDER BY NEWID() ' ...
        '        ) ' ...
        ') ' ...
