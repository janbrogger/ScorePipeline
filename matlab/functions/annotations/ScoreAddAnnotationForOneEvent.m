...
function data = ScoreAddAnnotationForOneEvent(searchResultStudyId, searchResultAnnotationConfigId, fieldType, value)    
...
sql = ['SELECT MIN(SearchResultEventAnnotationId) FROM SearchResult_Event_Annotation ' ...
    'INNER JOIN SearchResult_Event ON SearchResult_Event_Annotation.SearchResultEventId = SearchResult_Event.SearchResultEventId ' ...
    'INNER JOIN SearchResult_Study ON SearchResult_Event.SearchResultStudyId = SearchResult_Study.SearchResultStudyId ' ...
    'WHERE SearchResult_Study.SearchResultStudyId = ' searchResultStudyId ...
