function data = ScoreGetAnnotationsForOneEvent(searchResultEventId)    
    sql = [...
    'SELECT        SearchResult_AnnotationConfig.FieldName, SearchResult_Event_Annotation.ValueInt, '...
    '                         SearchResult_Event_Annotation.ValueFloat, SearchResult_Event_Annotation.ValueText, '...
